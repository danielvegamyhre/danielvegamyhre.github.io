---
layout: post
title:  "An illustrated deep dive into overlapping compute and comms in tensor parallelism"
...
### Custom ops with fused computation and communication via symmetric memory
