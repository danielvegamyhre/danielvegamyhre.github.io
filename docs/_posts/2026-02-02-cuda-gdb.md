...
### Context: kernel design of warp-specialized persistent GEMM kernel with 2 CTA tcgen05.mma

To get the most out of the debuggin steps below, it's best to have some context about what it is we are debugging.
...
<img src="/images/cuda-gdb/2cta.png" alt="2cta-mma" style="height: auto;">
